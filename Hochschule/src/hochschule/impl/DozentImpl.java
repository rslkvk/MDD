...
public class DozentImpl extends EObjectImpl implements Dozent {
	...
	protected EClass eStaticClass() {
		return HochschulePackage.Literals.DOZENT;
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectWithInverseResolvingEList<Vorlesung>(Vorlesung.class, this, HochschulePackage.DOZENT__VORLESUNG, HochschulePackage.VORLESUNG__DOZENT);
		}
		return vorlesung;
	}
	...
	public void setPersonalNr(String newPersonalNr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.DOZENT__PERSONAL_NR, oldPersonalNr, personalNr));
	}
	...
	public void setVorname(String newVorname) {
		...
		vorname = newVorname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.DOZENT__VORNAME, oldVorname, vorname));
	}
	...
	public void setNachname(String newNachname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.DOZENT__NACHNAME, oldNachname, nachname));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HochschulePackage.DOZENT__VORLESUNG:
