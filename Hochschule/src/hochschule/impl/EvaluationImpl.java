 ...
 * </p>
 * <ul>
 *   <li>{@link hochschule.impl.EvaluationImpl#getGesamtnote <em>Gesamtnote</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvaluationImpl extends EObjectImpl implements Evaluation {
	...
	protected EClass eStaticClass() {
		return HochschulePackage.Literals.EVALUATION;
	}
	...
	public void setGesamtnote(int newGesamtnote) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.EVALUATION__GESAMTNOTE, oldGesamtnote, gesamtnote));
	}
