...
public class VorlesungImpl extends EObjectImpl implements Vorlesung {
	...
	protected EClass eStaticClass() {
		return HochschulePackage.Literals.VORLESUNG;
	}
	...
	public EList<Student> getTutor() {
		if (tutor == null) {
			tutor = new EObjectResolvingEList<Student>(Student.class, this, HochschulePackage.VORLESUNG__TUTOR);
		}
		return tutor;
	}
	...
	public EList<Evaluation> getEvaluation() {
		if (evaluation == null) {
			evaluation = new EObjectContainmentEList<Evaluation>(Evaluation.class, this, HochschulePackage.VORLESUNG__EVALUATION);
		}
		return evaluation;
	}
		...
		if (dozent != null && dozent.eIsProxy()) {
			...
			if (dozent != oldDozent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HochschulePackage.VORLESUNG__DOZENT, oldDozent, dozent));
			}
		}
		return dozent;
	}
	...
	public NotificationChain basicSetDozent(Dozent newDozent, NotificationChain msgs) {
		...
		dozent = newDozent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HochschulePackage.VORLESUNG__DOZENT, oldDozent, newDozent);
	...
	public void setDozent(Dozent newDozent) {
		if (newDozent != dozent) {
			...
			if (dozent != null)
				msgs = ((InternalEObject)dozent).eInverseRemove(this, HochschulePackage.DOZENT__VORLESUNG, Dozent.class, msgs);
			if (newDozent != null)
				msgs = ((InternalEObject)newDozent).eInverseAdd(this, HochschulePackage.DOZENT__VORLESUNG, Dozent.class, msgs);
			msgs = basicSetDozent(newDozent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.VORLESUNG__DOZENT, newDozent, newDozent));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.VORLESUNG__NAME, oldName, name));
	}
	...
	public void setModulNr(String newModulNr) {
		...
		modulNr = newModulNr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.VORLESUNG__MODUL_NR, oldModulNr, modulNr));
	}
	...
	public void setBeschreibung(String newBeschreibung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.VORLESUNG__BESCHREIBUNG, oldBeschreibung, beschreibung));
	}
	...
	public void setCrP(String newCrP) {
		...
		crP = newCrP;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.VORLESUNG__CR_P, oldCrP, crP));
	}
	...
	public EList<Student> getStudent() {
		if (student == null) {
			student = new EObjectWithInverseResolvingEList.ManyInverse<Student>(Student.class, this, HochschulePackage.VORLESUNG__STUDENT, HochschulePackage.STUDENT__VORLESUNG);
		}
		return student;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HochschulePackage.VORLESUNG__DOZENT:
				if (dozent != null)
					msgs = ((InternalEObject)dozent).eInverseRemove(this, HochschulePackage.DOZENT__VORLESUNG, Dozent.class, msgs);
				return basicSetDozent((Dozent)otherEnd, msgs);
			case HochschulePackage.VORLESUNG__STUDENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HochschulePackage.VORLESUNG__TUTOR:
				return getTutor();
			case HochschulePackage.VORLESUNG__EVALUATION:
