...
public class FachbereichImpl extends EObjectImpl implements Fachbereich {
	...
	protected EClass eStaticClass() {
		return HochschulePackage.Literals.FACHBEREICH;
	}
	...
	public EList<Studiengang> getStudiengang() {
		if (studiengang == null) {
			studiengang = new EObjectContainmentEList<Studiengang>(Studiengang.class, this, HochschulePackage.FACHBEREICH__STUDIENGANG);
		}
		return studiengang;
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectResolvingEList<Vorlesung>(Vorlesung.class, this, HochschulePackage.FACHBEREICH__VORLESUNG);
		}
		return vorlesung;
	}
	...
	public EList<Dozent> getDozent() {
		if (dozent == null) {
			dozent = new EObjectContainmentEList<Dozent>(Dozent.class, this, HochschulePackage.FACHBEREICH__DOZENT);
		}
		return dozent;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.FACHBEREICH__NAME, oldName, name));
	}
	...
	public void setAlias(String newAlias) {
		...
		alias = newAlias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschulePackage.FACHBEREICH__ALIAS, oldAlias, alias));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HochschulePackage.FACHBEREICH__STUDIENGANG:
				return ((InternalEList<?>)getStudiengang()).basicRemove(otherEnd, msgs);
			case HochschulePackage.FACHBEREICH__DOZENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case HochschulePackage.FACHBEREICH__VORLESUNG:
				return getVorlesung();
			case HochschulePackage.FACHBEREICH__DOZENT:
				return getDozent();
			case HochschulePackage.FACHBEREICH__NAME:
				return getName();
			case HochschulePackage.FACHBEREICH__ALIAS:
				return getAlias();
		}
