 ...
 * @generated
 */
public class HochschuleSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static HochschulePackage modelPackage;
	 ...
	 * @generated
	 */
	public HochschuleSwitch() {
		if (modelPackage == null) {
			modelPackage = HochschulePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HochschulePackage.PROFESSOR: {
			...
			case HochschulePackage.STUDENT: {
				Student student = (Student)theEObject;
				T result = caseStudent(student);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HochschulePackage.EVALUATION: {
