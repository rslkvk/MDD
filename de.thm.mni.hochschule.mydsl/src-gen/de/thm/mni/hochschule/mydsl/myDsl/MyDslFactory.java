...
public interface MyDslFactory extends EFactory
{
   ...
   * @generated
   */
  MyDslFactory eINSTANCE = de.thm.mni.hochschule.mydsl.myDsl.impl.MyDslFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Lehrbeauftrager</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Lehrbeauftrager</em>'.
   * @generated
   */
  Lehrbeauftrager createLehrbeauftrager();
