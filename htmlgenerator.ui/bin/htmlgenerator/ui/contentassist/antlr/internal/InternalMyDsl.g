...
{ before(grammarAccess.getTextFieldAccess().getNameIDTerminalRuleCall_0_1_2_0()); }
	RULE_ID{ after(grammarAccess.getTextFieldAccess().getNameIDTerminalRuleCall_0_1_2_0()); }
)
...
{ before(grammarAccess.getTextFieldAccess().getLabelSTRINGTerminalRuleCall_0_1_4_0()); }
	RULE_STRING{ after(grammarAccess.getTextFieldAccess().getLabelSTRINGTerminalRuleCall_0_1_4_0()); }
)
...
{ before(grammarAccess.getMultilineFieldAccess().getLabelSTRINGTerminalRuleCall_5_0()); }
	RULE_STRING{ after(grammarAccess.getMultilineFieldAccess().getLabelSTRINGTerminalRuleCall_5_0()); }
)
