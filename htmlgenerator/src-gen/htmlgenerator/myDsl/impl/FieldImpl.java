 ...
 * </p>
 * <ul>
 *   <li>{@link htmlgenerator.myDsl.impl.FieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link htmlgenerator.myDsl.impl.FieldImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldImpl extends MinimalEObjectImpl.Container implements Field
{
  ...
  public void setLabel(String newLabel)
  {
    ...
    label = newLabel;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.FIELD__LABEL, oldLabel, label));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.FIELD__NAME:
        return getName();
      case MyDslPackage.FIELD__LABEL:
        return getLabel();
    }
