 ...
 * generated by Xtext
 */
package htmlgenerator.services;
...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TextFieldElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cNameKeyword_0_1_1 = (Keyword)cGroup_0_1.eContents().get(1);
		...
		private final Keyword cLabelKeyword_0_1_3 = (Keyword)cGroup_0_1.eContents().get(3);
		private final Assignment cLabelAssignment_0_1_4 = (Assignment)cGroup_0_1.eContents().get(4);
		private final RuleCall cLabelSTRINGTerminalRuleCall_0_1_4_0 = (RuleCall)cLabelAssignment_0_1_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_0_1_5 = (Keyword)cGroup_0_1.eContents().get(5);
		private final RuleCall cMultilineFieldParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//"Name"
		public Keyword getNameKeyword_0_1_1() { return cNameKeyword_0_1_1; }
		...
		//"Label"
		public Keyword getLabelKeyword_0_1_3() { return cLabelKeyword_0_1_3; }

		//label=STRING
		public Assignment getLabelAssignment_0_1_4() { return cLabelAssignment_0_1_4; }

		//STRING
		public RuleCall getLabelSTRINGTerminalRuleCall_0_1_4_0() { return cLabelSTRINGTerminalRuleCall_0_1_4_0; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_0_1_5() { return cRightCurlyBracketKeyword_0_1_5; }

		//MultilineField
		public RuleCall getMultilineFieldParserRuleCall_1() { return cMultilineFieldParserRuleCall_1; }
	}
	...
	public class MultilineFieldElements extends AbstractParserRuleElementFinder {
		...
		//MultilineField:
		//	"MultilineField" "{" "Name" name=ID "Label" label=STRING "}";
		@Override public ParserRule getRule() { return rule; }
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("htmlgenerator.MyDsl".equals(grammar.getName())) {
				return grammar;
			}
