...
public class StudiengangImpl extends MinimalEObjectImpl.Container implements Studiengang {
	...
	protected EClass eStaticClass() {
		return HmodelPackage.Literals.STUDIENGANG;
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectContainmentEList<Vorlesung>(Vorlesung.class, this, HmodelPackage.STUDIENGANG__VORLESUNG);
		}
		return vorlesung;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.STUDIENGANG__NAME, oldName, name));
	}
	...
	public void setNC(String newNC) {
		...
		nc = newNC;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.STUDIENGANG__NC, oldNC, nc));
	}
	...
	public EList<Student> getStudent() {
		if (student == null) {
			student = new EObjectResolvingEList<Student>(Student.class, this, HmodelPackage.STUDIENGANG__STUDENT);
		}
		return student;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HmodelPackage.STUDIENGANG__VORLESUNG:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HmodelPackage.STUDIENGANG__VORLESUNG:
				return getVorlesung();
			case HmodelPackage.STUDIENGANG__NAME:
				return getName();
			case HmodelPackage.STUDIENGANG__NC:
				return getNC();
			case HmodelPackage.STUDIENGANG__STUDENT:
				return getStudent();
		}
