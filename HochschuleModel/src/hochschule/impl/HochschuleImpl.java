...
public class HochschuleImpl extends MinimalEObjectImpl.Container implements Hochschule {
	...
	protected EClass eStaticClass() {
		return HmodelPackage.Literals.HOCHSCHULE;
	}
	...
	public EList<Fachbereich> getFachbereich() {
		if (fachbereich == null) {
			fachbereich = new EObjectContainmentEList<Fachbereich>(Fachbereich.class, this, HmodelPackage.HOCHSCHULE__FACHBEREICH);
		}
		return fachbereich;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.HOCHSCHULE__NAME, oldName, name));
	}
	...
	public EList<Student> getStudent() {
		if (student == null) {
			student = new EObjectContainmentEList<Student>(Student.class, this, HmodelPackage.HOCHSCHULE__STUDENT);
		}
		return student;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HmodelPackage.HOCHSCHULE__FACHBEREICH:
				return ((InternalEList<?>)getFachbereich()).basicRemove(otherEnd, msgs);
			case HmodelPackage.HOCHSCHULE__STUDENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case HmodelPackage.HOCHSCHULE__NAME:
				return getName();
			case HmodelPackage.HOCHSCHULE__STUDENT:
				return getStudent();
		}
