...
public class StudentImpl extends MinimalEObjectImpl.Container implements Student {
	...
	protected EClass eStaticClass() {
		return HmodelPackage.Literals.STUDENT;
	}
	...
	public void setMatrikelNr(String newMatrikelNr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.STUDENT__MATRIKEL_NR, oldMatrikelNr, matrikelNr));
	}
	...
	public void setVorname(String newVorname) {
		...
		vorname = newVorname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.STUDENT__VORNAME, oldVorname, vorname));
	}
	...
	public void setNachname(String newNachname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.STUDENT__NACHNAME, oldNachname, nachname));
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectWithInverseResolvingEList.ManyInverse<Vorlesung>(Vorlesung.class, this, HmodelPackage.STUDENT__VORLESUNG, HmodelPackage.VORLESUNG__STUDENT);
		}
		return vorlesung;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HmodelPackage.STUDENT__VORLESUNG:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HmodelPackage.STUDENT__MATRIKEL_NR:
				return getMatrikelNr();
			case HmodelPackage.STUDENT__VORNAME:
				return getVorname();
			case HmodelPackage.STUDENT__NACHNAME:
				return getNachname();
			case HmodelPackage.STUDENT__VORLESUNG:
				return getVorlesung();
		}
