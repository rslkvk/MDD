 ...
 * </p>
 * <ul>
 *   <li>{@link hochschule.impl.VorlesungImpl#getTutor <em>Tutor</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getEvaluation <em>Evaluation</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getDozent <em>Dozent</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getName <em>Name</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getModulNr <em>Modul Nr</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getBeschreibung <em>Beschreibung</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getCrP <em>Cr P</em>}</li>
 *   <li>{@link hochschule.impl.VorlesungImpl#getStudent <em>Student</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VorlesungImpl extends MinimalEObjectImpl.Container implements Vorlesung {
	...
	protected EClass eStaticClass() {
		return HmodelPackage.Literals.VORLESUNG;
	}
	...
	public EList<Student> getTutor() {
		if (tutor == null) {
			tutor = new EObjectResolvingEList<Student>(Student.class, this, HmodelPackage.VORLESUNG__TUTOR);
		}
		return tutor;
	}
	...
	public EList<Evaluation> getEvaluation() {
		if (evaluation == null) {
			evaluation = new EObjectContainmentEList<Evaluation>(Evaluation.class, this, HmodelPackage.VORLESUNG__EVALUATION);
		}
		return evaluation;
	}
		...
		if (dozent != null && dozent.eIsProxy()) {
			...
			if (dozent != oldDozent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HmodelPackage.VORLESUNG__DOZENT, oldDozent, dozent));
			}
		}
		return dozent;
	}
	...
	public NotificationChain basicSetDozent(Dozent newDozent, NotificationChain msgs) {
		...
		dozent = newDozent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HmodelPackage.VORLESUNG__DOZENT, oldDozent, newDozent);
	...
	public void setDozent(Dozent newDozent) {
		if (newDozent != dozent) {
			...
			if (dozent != null)
				msgs = ((InternalEObject)dozent).eInverseRemove(this, HmodelPackage.DOZENT__VORLESUNG, Dozent.class, msgs);
			if (newDozent != null)
				msgs = ((InternalEObject)newDozent).eInverseAdd(this, HmodelPackage.DOZENT__VORLESUNG, Dozent.class, msgs);
			msgs = basicSetDozent(newDozent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.VORLESUNG__DOZENT, newDozent, newDozent));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.VORLESUNG__NAME, oldName, name));
	}
	...
	public void setModulNr(String newModulNr) {
		...
		modulNr = newModulNr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.VORLESUNG__MODUL_NR, oldModulNr, modulNr));
	}
	...
	public void setBeschreibung(String newBeschreibung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.VORLESUNG__BESCHREIBUNG, oldBeschreibung, beschreibung));
	}
	...
	public void setCrP(String newCrP) {
		...
		crP = newCrP;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.VORLESUNG__CR_P, oldCrP, crP));
	}
	...
	public EList<Student> getStudent() {
		if (student == null) {
			student = new EObjectWithInverseResolvingEList.ManyInverse<Student>(Student.class, this, HmodelPackage.VORLESUNG__STUDENT, HmodelPackage.STUDENT__VORLESUNG);
		}
		return student;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HmodelPackage.VORLESUNG__DOZENT:
				if (dozent != null)
					msgs = ((InternalEObject)dozent).eInverseRemove(this, HmodelPackage.DOZENT__VORLESUNG, Dozent.class, msgs);
				return basicSetDozent((Dozent)otherEnd, msgs);
			case HmodelPackage.VORLESUNG__STUDENT:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HmodelPackage.VORLESUNG__EVALUATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HmodelPackage.VORLESUNG__TUTOR:
				return getTutor();
			case HmodelPackage.VORLESUNG__EVALUATION:
			...
			case HmodelPackage.VORLESUNG__NAME:
				return getName();
			case HmodelPackage.VORLESUNG__MODUL_NR:
				return getModulNr();
			case HmodelPackage.VORLESUNG__BESCHREIBUNG:
				return getBeschreibung();
			case HmodelPackage.VORLESUNG__CR_P:
				return getCrP();
			case HmodelPackage.VORLESUNG__STUDENT:
				return getStudent();
		}
