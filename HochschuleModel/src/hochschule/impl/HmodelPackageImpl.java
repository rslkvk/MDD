...
import hochschule.HmodelFactory;
 ...
 * @generated
 */
public class HmodelPackageImpl extends EPackageImpl implements HmodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see hochschule.HmodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HmodelPackageImpl() {
		super(eNS_URI, HmodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HmodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HmodelPackage init() {
		if (isInited) return (HmodelPackage)EPackage.Registry.INSTANCE.getEPackage(HmodelPackage.eNS_URI);

		// Obtain or create and register package
		HmodelPackageImpl theHmodelPackage = (HmodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HmodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HmodelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theHmodelPackage.createPackageContents();

		// Initialize created meta-data
		theHmodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theHmodelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HmodelPackage.eNS_URI, theHmodelPackage);
		return theHmodelPackage;
	}
	 ...
	 * @generated
	 */
	public HmodelFactory getHmodelFactory() {
		return (HmodelFactory)getEFactoryInstance();
	}
