...
public class EvaluationImpl extends MinimalEObjectImpl.Container implements Evaluation {
	...
	protected EClass eStaticClass() {
		return HmodelPackage.Literals.EVALUATION;
	}
	...
	public void setGesamtnote(int newGesamtnote) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmodelPackage.EVALUATION__GESAMTNOTE, oldGesamtnote, gesamtnote));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HmodelPackage.EVALUATION__GESAMTNOTE:
