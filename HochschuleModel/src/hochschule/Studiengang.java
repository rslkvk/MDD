 ...
 * </ul>
 *
 * @see hochschule.HmodelPackage#getStudiengang()
 * @model
 * @generated
 */
public interface Studiengang extends EObject {
	 ...
	 * @see hochschule.HmodelPackage#getStudiengang_Vorlesung()
	 ...
	 * @see #setName(String)
	 * @see hochschule.HmodelPackage#getStudiengang_Name()
	 * @model
	 * @generated
	 */
	String getName();
	 ...
	 * @see #setNC(String)
	 * @see hochschule.HmodelPackage#getStudiengang_NC()
	 * @model
	 * @generated
	 */
	String getNC();
	 ...
	 * @see hochschule.HmodelPackage#getStudiengang_Student()
	 * @model required="true"
	 * @generated
	 */
