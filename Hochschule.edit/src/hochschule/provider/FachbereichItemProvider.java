...
/**
 * This is the item provider adapter for a {@link hochschule.Fachbereich} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FachbereichItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HochschulePackage.Literals.FACHBEREICH__VORLESUNG,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HochschulePackage.Literals.FACHBEREICH__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HochschulePackage.Literals.FACHBEREICH__ALIAS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HochschulePackage.Literals.FACHBEREICH__STUDIENGANG);
			childrenFeatures.add(HochschulePackage.Literals.FACHBEREICH__DOZENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HochschulePackage.Literals.FACHBEREICH__STUDIENGANG,
				 HochschuleFactory.eINSTANCE.createStudiengang()));

		newChildDescriptors.add
			(createChildParameter
				(HochschulePackage.Literals.FACHBEREICH__DOZENT,
				 HochschuleFactory.eINSTANCE.createDozent()));

		newChildDescriptors.add
			(createChildParameter
				(HochschulePackage.Literals.FACHBEREICH__DOZENT,
				 HochschuleFactory.eINSTANCE.createLehrbeauftragter()));

		newChildDescriptors.add
			(createChildParameter
				(HochschulePackage.Literals.FACHBEREICH__DOZENT,
				 HochschuleFactory.eINSTANCE.createProfessor()));
	}
