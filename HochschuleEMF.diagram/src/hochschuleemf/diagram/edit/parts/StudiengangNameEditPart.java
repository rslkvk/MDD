 ...
 * @generated
 */
public class StudiengangNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StudiengangNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HochschuleemfParserProvider.getParser(HochschuleemfElementTypes.Studiengang_3001,
					getParserElement(), HochschuleemfVisualIDRegistry
							.getType(hochschuleemf.diagram.edit.parts.StudiengangNameEditPart.VISUAL_ID));
		}
		return parser;
	}
