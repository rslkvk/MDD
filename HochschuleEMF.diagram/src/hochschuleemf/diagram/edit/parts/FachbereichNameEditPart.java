...
import hochschuleemf.diagram.edit.policies.HochschuleemfTextSelectionEditPolicy;
 ...
 * @generated
 */
public class FachbereichNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FachbereichNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new HochschuleemfTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return HochschuleemfElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HochschuleemfParserProvider.getParser(HochschuleemfElementTypes.Fachbereich_2001,
					getParserElement(), HochschuleemfVisualIDRegistry
							.getType(hochschuleemf.diagram.edit.parts.FachbereichNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, HochschuleemfEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
