 ...
 * @generated
 */
public class HochschuleemfValidationProvider {
	...
	public static void runWithConstraints(TransactionalEditingDomain editingDomain, Runnable operation) {
		...
		if (editingDomain != null) {
			try {
				...
				HochschuleemfDiagramEditorPlugin.getInstance().logError("Validation failed", e); //$NON-NLS-1$
			}
		} else {
			task.run();
		}
	...
	static boolean isInDefaultEditorContext(Object object) {
		...
		if (object instanceof View) {
			return constraintsActive
					&& HochschuleEditPart.MODEL_ID.equals(HochschuleemfVisualIDRegistry.getModelID((View) object));
		}
		return true;
	}
