...
import de.thm.mni.htmlgen.hTMLGen.HTMLGenFactory;
 ...
 * @generated
 */
public class HTMLGenPackageImpl extends EPackageImpl implements HTMLGenPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass multilineFieldEClass = null;
   ...
   * @see de.thm.mni.htmlgen.hTMLGen.HTMLGenPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private HTMLGenPackageImpl()
  {
    super(eNS_URI, HTMLGenFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link HTMLGenPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static HTMLGenPackage init()
  {
    if (isInited) return (HTMLGenPackage)EPackage.Registry.INSTANCE.getEPackage(HTMLGenPackage.eNS_URI);

    // Obtain or create and register package
    HTMLGenPackageImpl theHTMLGenPackage = (HTMLGenPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HTMLGenPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HTMLGenPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theHTMLGenPackage.createPackageContents();

    // Initialize created meta-data
    theHTMLGenPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theHTMLGenPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(HTMLGenPackage.eNS_URI, theHTMLGenPackage);
    return theHTMLGenPackage;
  }
   ...
   * @generated
   */
  public EClass getMultilineField()
  {
    return multilineFieldEClass;
  }
   ...
   * @generated
   */
  public HTMLGenFactory getHTMLGenFactory()
  {
    return (HTMLGenFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    multilineFieldEClass = createEClass(MULTILINE_FIELD);
  }
  ...
  public void initializePackageContents()
  {
    ...
    multilineFieldEClass.getESuperTypes().add(this.getTextField());

    // Initialize classes and features; add operations and parameters
    initEClass(modelEClass, Model.class, "Model", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getModel_Model(), this.getForm(), null, "model", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getForm_Form(), this.getField(), null, "form", null, 0, -1, Form.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(multilineFieldEClass, MultilineField.class, "MultilineField", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
