 ...
 * @generated
 */
public class HochschuleemfPackageImpl extends EPackageImpl implements HochschuleemfPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see hochschuleemf.HochschuleemfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HochschuleemfPackageImpl() {
		super(eNS_URI, HochschuleemfFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HochschuleemfPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HochschuleemfPackage init() {
		if (isInited) return (HochschuleemfPackage)EPackage.Registry.INSTANCE.getEPackage(HochschuleemfPackage.eNS_URI);

		// Obtain or create and register package
		HochschuleemfPackageImpl theHochschuleemfPackage = (HochschuleemfPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HochschuleemfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HochschuleemfPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theHochschuleemfPackage.createPackageContents();

		// Initialize created meta-data
		theHochschuleemfPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theHochschuleemfPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HochschuleemfPackage.eNS_URI, theHochschuleemfPackage);
		return theHochschuleemfPackage;
	}
	 ...
	 * @generated
	 */
	public HochschuleemfFactory getHochschuleemfFactory() {
		return (HochschuleemfFactory)getEFactoryInstance();
	}
	...
	protected void createGmf_2Annotations() {
		...
		addAnnotation
		  (getHochschule_Fachbereich(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (getFachbereich_Studiengang(), 
		   source, 
		   new String[] {
		   });
	}
