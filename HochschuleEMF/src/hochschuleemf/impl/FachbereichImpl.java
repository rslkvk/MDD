 ...
 * </p>
 * <ul>
 *   <li>{@link hochschuleemf.impl.FachbereichImpl#getStudiengang <em>Studiengang</em>}</li>
 *   <li>{@link hochschuleemf.impl.FachbereichImpl#getVorlesung <em>Vorlesung</em>}</li>
 *   <li>{@link hochschuleemf.impl.FachbereichImpl#getDozent <em>Dozent</em>}</li>
 *   <li>{@link hochschuleemf.impl.FachbereichImpl#getName <em>Name</em>}</li>
 *   <li>{@link hochschuleemf.impl.FachbereichImpl#getAlias <em>Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FachbereichImpl extends EObjectImpl implements Fachbereich {
	/**
	...
	protected EClass eStaticClass() {
		return HochschuleemfPackage.Literals.FACHBEREICH;
	}
	...
	public EList<Studiengang> getStudiengang() {
		if (studiengang == null) {
			studiengang = new EObjectContainmentEList<Studiengang>(Studiengang.class, this, HochschuleemfPackage.FACHBEREICH__STUDIENGANG);
		}
		return studiengang;
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectResolvingEList<Vorlesung>(Vorlesung.class, this, HochschuleemfPackage.FACHBEREICH__VORLESUNG);
		}
		return vorlesung;
	}
	...
	public EList<Dozent> getDozent() {
		if (dozent == null) {
			dozent = new EObjectContainmentEList<Dozent>(Dozent.class, this, HochschuleemfPackage.FACHBEREICH__DOZENT);
		}
		return dozent;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.FACHBEREICH__NAME, oldName, name));
	}
	...
	public void setAlias(String newAlias) {
		...
		alias = newAlias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.FACHBEREICH__ALIAS, oldAlias, alias));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case HochschuleemfPackage.FACHBEREICH__VORLESUNG:
				return getVorlesung();
			case HochschuleemfPackage.FACHBEREICH__DOZENT:
				return getDozent();
