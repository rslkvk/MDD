 ...
 * </p>
 * <ul>
 *   <li>{@link hochschuleemf.impl.DozentImpl#getVorlesung <em>Vorlesung</em>}</li>
 *   <li>{@link hochschuleemf.impl.DozentImpl#getPersonalNr <em>Personal Nr</em>}</li>
 *   <li>{@link hochschuleemf.impl.DozentImpl#getVorname <em>Vorname</em>}</li>
 *   <li>{@link hochschuleemf.impl.DozentImpl#getNachname <em>Nachname</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DozentImpl extends EObjectImpl implements Dozent {
	...
	protected EClass eStaticClass() {
		return HochschuleemfPackage.Literals.DOZENT;
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectWithInverseResolvingEList<Vorlesung>(Vorlesung.class, this, HochschuleemfPackage.DOZENT__VORLESUNG, HochschuleemfPackage.VORLESUNG__DOZENT);
		}
		return vorlesung;
	}
	...
	public void setPersonalNr(String newPersonalNr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.DOZENT__PERSONAL_NR, oldPersonalNr, personalNr));
	}
	...
	public void setVorname(String newVorname) {
		...
		vorname = newVorname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.DOZENT__VORNAME, oldVorname, vorname));
	}
	...
	public void setNachname(String newNachname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.DOZENT__NACHNAME, oldNachname, nachname));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HochschuleemfPackage.DOZENT__VORLESUNG:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HochschuleemfPackage.DOZENT__VORLESUNG:
				return getVorlesung();
			case HochschuleemfPackage.DOZENT__PERSONAL_NR:
				return getPersonalNr();
			case HochschuleemfPackage.DOZENT__VORNAME:
				return getVorname();
			case HochschuleemfPackage.DOZENT__NACHNAME:
				return getNachname();
		}
