 ...
 * </p>
 * <ul>
 *   <li>{@link hochschuleemf.impl.StudentImpl#getMatrikelNr <em>Matrikel Nr</em>}</li>
 *   <li>{@link hochschuleemf.impl.StudentImpl#getVorname <em>Vorname</em>}</li>
 *   <li>{@link hochschuleemf.impl.StudentImpl#getNachname <em>Nachname</em>}</li>
 *   <li>{@link hochschuleemf.impl.StudentImpl#getVorlesung <em>Vorlesung</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudentImpl extends EObjectImpl implements Student {
	...
	protected EClass eStaticClass() {
		return HochschuleemfPackage.Literals.STUDENT;
	}
	...
	public void setMatrikelNr(String newMatrikelNr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.STUDENT__MATRIKEL_NR, oldMatrikelNr, matrikelNr));
	}
	...
	public void setVorname(String newVorname) {
		...
		vorname = newVorname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.STUDENT__VORNAME, oldVorname, vorname));
	}
	...
	public void setNachname(String newNachname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.STUDENT__NACHNAME, oldNachname, nachname));
	}
	...
	public EList<Vorlesung> getVorlesung() {
		if (vorlesung == null) {
			vorlesung = new EObjectWithInverseResolvingEList.ManyInverse<Vorlesung>(Vorlesung.class, this, HochschuleemfPackage.STUDENT__VORLESUNG, HochschuleemfPackage.VORLESUNG__STUDENT);
		}
		return vorlesung;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HochschuleemfPackage.STUDENT__VORLESUNG:
