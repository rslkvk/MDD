 ...
 * </p>
 * <ul>
 *   <li>{@link hochschuleemf.impl.HochschuleImpl#getFachbereich <em>Fachbereich</em>}</li>
 *   <li>{@link hochschuleemf.impl.HochschuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link hochschuleemf.impl.HochschuleImpl#getStudent <em>Student</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HochschuleImpl extends EObjectImpl implements Hochschule {
	...
	protected EClass eStaticClass() {
		return HochschuleemfPackage.Literals.HOCHSCHULE;
	}
	...
	public EList<Fachbereich> getFachbereich() {
		if (fachbereich == null) {
			fachbereich = new EObjectContainmentEList<Fachbereich>(Fachbereich.class, this, HochschuleemfPackage.HOCHSCHULE__FACHBEREICH);
		}
		return fachbereich;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HochschuleemfPackage.HOCHSCHULE__NAME, oldName, name));
	}
	...
	public EList<Student> getStudent() {
		if (student == null) {
			student = new EObjectContainmentEList<Student>(Student.class, this, HochschuleemfPackage.HOCHSCHULE__STUDENT);
		}
		return student;
	}
